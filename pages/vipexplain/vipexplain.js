// pages/vipexplain/vipexplain.js
const app = getApp();
Page({
  ...
  aboutus: function () {
    var that = this
    var data = {}
    app.request('/level/rights', data, this, (that, res) => {
      var rights = res.data.results
      ...
      WxParse.wxParse('content', 'html', rights, that, 5);
      that.setData({
        rights: rights
      })
    })
